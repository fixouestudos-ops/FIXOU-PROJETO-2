...
function handleAction(action,id,element){
 ...
 if(action==='review-approve-content'){const q=BANK.questions.find(x=>x.id===id);if(q){q.contentStatus='validated';q.needsReview=false;saveProgress();render();toast('Conteúdo aprovado.');}return;}
