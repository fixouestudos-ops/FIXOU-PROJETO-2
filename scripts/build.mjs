...
if(bank.questions.filter(q=>q.discipline==='biologia').length!==50||new Set(bank.questions.map(q=>q.id)).size!==bank.questions.length)throw new Error('A migração deve preservar as 50 questões de Biologia sem duplicar IDs.');
